...
| Image | Status |
| ------------- | ------------- |
| Shopping Client |  [![Build Status](https://dev.azure.com/geovanebelisario/Shopping/_apis/build/status/shoppingclient-pipeline?branchName=master)](https://dev.azure.com/geovanebelisario/Shopping/_build/latest?definitionId=5&branchName=master) |
| Shopping API | [![Build Status](https://dev.azure.com/geovanebelisario/Shopping/_apis/build/status/shoppingapi-pipeline?branchName=master)](https://dev.azure.com/geovanebelisario/Shopping/_build/latest?definitionId=3&branchName=master) | | |


**UDEMY COURSE WITH DISCOUNTED - Step by Step Development of this repository -> https://www.udemy.com/course/deploying-net-microservices-with-k8s-aks-and-azure-devops/?couponCode=FEBRUARY22**
